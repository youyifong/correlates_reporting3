...
cat("In the following results, each table contains estimated coefficients from one Cox model. The figures on a page are based on the underlying model from that same page.\n\n")
cat ("\\clearpage")
